  ...
  var portfolioModalItems = [
    ...
    },
    {
      ...
      carouselItems: [
        ...
        {
          img: "img/portfolio/abc/1.gif"
        }, 
        {
          img: "img/portfolio/abc/1-mobile.gif"
        }, 
        {
          img: "img/portfolio/abc/if"
        }, 
        {
          img: "img/portfolio/abc/4.gif"
        }, 
        {
          img: "img/portfolio/abc/5.gif"
        },
        {
          img: "img/portfolio/abc/6.gif"
        },
        {
          img: "img/portfolio/abc/1_mobile.gif"
        },
        {
          img: "img/portfolio/abc/2_mobile.gif"
        }
       ],
      description:"A responsive website built for especial.digital, according to their design.",
      date:"August 2019",
